"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="339c6f22-4205-55a9-beb9-edab16250f51")}catch(e){}}();
...
exports.lang = {
    ...
    ERROR_CODE_0001: "This error code means that when you tried to edit a message using the web editor and pressed export, Threaded was then unable to find that message.\nThis was likely caused by someone deleting the message while it was being edited",
    ERROR_CODE_0002: "This error was caused by the document Threaded was trying to access at the time being missing. It may be temporary or permanent depending on what Threaded was trying to access.",
    ERROR_CODE_0003: "This error means that you are exceeding one of Threaded's limits for a certain feature",
    ERROR_CODE_0004: "This will only be shown if you have tried to modify the data being sent between the website and bot",
    ERROR_CODE_1001: "Your account has a role that is blacklisted from taking this application",
    ERROR_CODE_1002: "Your account does not have all the required roles to take this application",
    ...
    ERROR_CODE_1005: "You are on cooldown for taking this application, try again in a little while",
    ERROR_CODE_1006: "This application is not currently accepting responses",
    ERROR_CODE_1007: "You are already attempting an application, finish or cancel it before starting another",
    ERROR_CODE_1008: "You are not currently completing an application",
    ERROR_CODE_1009: "The given response was too short. It must be at least {min} characters",
    ERROR_CODE_1010: "The given response was too long. It must be at most {max} characters",
    ...
    ERROR_CODE_2001: "You have a role that is blacklisted from using this ticket trigger",
    ERROR_CODE_2002: "You do not have all the required roles to use this ticket trigger",
    ...
    SCHEDULE_TICKET_CLOSE: "This ticket has been scheduled to close in {duration}",
    SCHEDULE_TICKET_CLOSE_ALREADY: "This ticket has already been scheduled to close",
    ...
    TICKET_CLOSE_REOPEN_MESSAGE: "This ticket has been scheduled to close in {duration}",
    ...
    TICKET_CLOSED_SO_CANNOT_LOCK: "This ticket has been scheduled to close so cannot be locked",
    ...
    APPLICATION_DEFAULT_MESSAGE_SUBMITTED_BUTTON: "Want your own application? Add Threaded!",
    NO_ACTION_SELF: "You can't do this to yourself",
    TICKET_NOT_OPEN: "This ticket is not open",
    AWAIT_ACTION_FAIL_NOT_OPEN: "The await-reply action cannot run on this ticket as it is not open",
    TICKET_ALREADY_AWAITING: "This ticket is already waiting for a response",
    TICKET_AWAIT_CANCEL: "The reply-request has been canceled for this ticket by <@{user}>",
    TICKET_NOT_AWAITING: "This ticket has no pending reply-requests",
    TICKET_AWAIT_REQUEST_DONE: "If this ticket gets no reply {time} then it will be {action}",
    ...
    TICKET_ALREADY_OPEN: "This ticket is already open - if permission changes don't appear to be happening, this may be because of Discord rate limits. Threaded will sort it out *eventually*",
    ...
    LANGUAGE_UPDATED: "The preferred language for this server has been updated to `{new_language}`",
    COMMANDS_TRANSLATE_MESSAGE_TRANSLATED: "Here is your translated message:",
    COMMANDS_TRANSLATE_NO_CONTENT_TO_TRANSLATE: "This message does not have any content for me to translate!",
    PROCESSING_PANEL: "I am processing your panel. It will be sent in this channel when I am done",
    NO_RECORDS: "I was not able to find any records matching your query",
    SET_AUTO_RESPONDER_ALLOWED_CHANNELS: "Use the below dropdown to set which channels your auto responders will work in",
    ...
    CONFIG_CREATE_APPLICATION_NOT_FOUND: "I could not find an application with that name",
    CONFIG_CREATE_TICKET_TRIGGER_NOT_FOUND: "I could not find a ticket trigger with that name",
    MESSAGE_CANNOT_SEND_AS_INVALID: "I was unable to send that message as it is malformed",
    MESSAGE_NAME_NOT_VALID: "Your message name can only include alpha numeric characters, '-', '_' and spaces",
    MESSAGE_CREATE_GOTO_LINK: "Head to {link} to edit your message\n-# DO NOT share this link with anyone otherwise they will be able to create messages on your server",
    GROUP_CREATE_GOTO_LINK: "Head to {link} to edit your group\n-# DO NOT share this link with anyone otherwise they will be able to create groups on your server",
    APPLICATION_CREATE_GOTO_LINK: "Head to {link} to edit your application\n-# DO NOT share this link with anyone otherwise they will be able to create applications on your server",
    TICKET_TRIGGER_CREATE_GOTO_LINK: "Head to {link} to edit your ticket trigger\n-# DO NOT share this link with anyone otherwise they will be able to create triggers on your server",
    ...
    INVALID_MATCHER_REGEX: "The matcher regex you provided is invalid. Make sure that the regex string is valid and does not contain excessive backtracking",
    ...
    NEW_APPLICATION_SUBMIT_BODY_INFORMATION: "View the application in the attached thread!",
    NEW_APPLICATION_LOG_BODY: "{user} has submitted an application for {application}",
    APPLICATION_DIRECT_TO_DMS: "Head over to your DMs to start the application!\n-# If you do not get a DM, please check that you have DMs enabled for this server",
    APPLICATION_IDS_DO_NOT_MATCH: "Looks like we're out of sync, this application ID does not match with the one that I thought you were doing. Try canceling and starting again ._.",
    APPLICATION_DEFAULT_MESSAGE_CONFIRMATION: "Are you sure you want to start the application for {applicationName}? You can cancel at any time by replying with `cancel`",
    APPLICATION_DEFAULT_MESSAGE_CANCELED: "I have canceled your application for {applicationName}. You can restart the application from the same place that you started it!",
    APPLICATION_DEFAULT_MESSAGE_SUBMITTED: "Your application for {applicationName} has been submitted!",
    APPLICATION_DEFAULT_MESSAGE_ACCEPTED: "Your application for {applicationName} in {serverName} has been accepted! The reviewer gave the following reason: {reason}",
    APPLICATION_DEFAULT_MESSAGE_REJECTED: "Your application for {applicationName} in {server.name} has been rejected! The reviewer gave the following reason: {reason}",
    APPLICATION_VERDICT_ACCEPT_HEADER: "Application accepted by {user} with the reason {reason}",
    APPLICATION_VERDICT_REJECT_HEADER: "Application rejected by {user} with the reason {reason}",
    TICKET_CLOSE_DM_BUTTON: "Want your own ticket system? Invite Threaded!",
};
//# sourceMappingURL=messages.js.map
//# debugId=339c6f22-4205-55a9-beb9-edab16250f51
