"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="79df6da4-cbaa-5539-80a8-1e0cf2a08238")}catch(e){}}();
...
const command = {
    ...
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .addUserOption((opt) => opt.setDescription("Select a user").setName("user").setRequired(true)),
    ...
    async execute(client, data, interaction) {
        ...
        if (!userPermissions.applications.manage &&
            ...
            return interaction.editReply((await (0, onError_1.onError)(new Error("Missing manage/respond permission")))
                .discordMsg);
        const allApplications = await (0, getServer_1.getUserCompletedApplications)(application._id, user.id);
        if (!allApplications.length)
            return interaction.editReply((await (0, onError_1.onError)(new Error("No records"))).discordMsg);
...
//# debugId=79df6da4-cbaa-5539-80a8-1e0cf2a08238
