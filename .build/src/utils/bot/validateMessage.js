"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="f6c706be-d0c7-5e00-b91b-40bf86a62b3b")}catch(e){}}();
    ...
    for (let i = 0; i < message.embeds.length; i++) {
        ...
        embed.fields?.forEach((field, j) => {
            if (field.name.length > 256 || field.value.length > 1024) {
                errors.push({
                    type: "embed",
                    message: `${indexLabel} field #${j + 1} has a name or value that is too long.`,
                });
            }
        });
...
//# debugId=f6c706be-d0c7-5e00-b91b-40bf86a62b3b
