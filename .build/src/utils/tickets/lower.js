"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="d2eb66e3-87ca-5a49-9354-0d3f20149900")}catch(e){}}();

var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.lowerTicket = lowerTicket;
...
async function lowerTicket(ticketId, locale, repliable) {
    ...
    if (!ticket.isRaised)
        return repliable?.editReply((0, lang_1.t)(locale, "TICKET_ALREADY_LOWERED"));
    if (!ticket.allowRaising)
        return repliable?.editReply((0, lang_1.t)(locale, "TICKET_DOES_NOT_ALLOW_RAISE"));
    await Ticket_1.TicketSchema.findOneAndUpdate({ _id: ticketId }, { isRaised: false });
    ...
    const logChannel = (0, sendLogToWebhook_1.getAvailableLogChannel)(server.settings.logging, "tickets.lower");
    if (logChannel)
            ...
            embeds: [
                {
                    ...
                    title: (0, lang_1.t)(server.preferredLanguage, "TICKET_LOWER_LOG_TITLE"),
                    description: (0, lang_1.t)(server.preferredLanguage, `TICKET_LOWER_LOG_BODY`, {
                        user: `<@${ticket.owner}>`,
                    }),
                },
            ],
