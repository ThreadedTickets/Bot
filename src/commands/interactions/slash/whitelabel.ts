...
const command: AppCommand = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((o) =>
      o
        ...
        .setDescription(".")
        .addUserOption((o) =>
          o.setName("owner").setDescription(".").setRequired(true)
        )
        .addStringOption((o) =>
          o.setName("token").setDescription(".").setRequired(true)
        )
        .addStringOption((o) =>
          o.setName("client_id").setDescription(".").setRequired(true)
        )
        .addStringOption((o) =>
          o.setName("servers").setDescription(".").setRequired(true)
        )
        .addStringOption((o) =>
          o.setName("redis_prefix").setDescription(".").setRequired(false)
        )
        .addStringOption((o) =>
          o.setName("prefix").setDescription(".").setRequired(false)
        )
        .addStringOption((o) =>
          o
            .setName("status")
        ...
        .addStringOption((o) =>
          o.setName("activity_text").setDescription(".").setRequired(false)
        )
        .addStringOption((o) =>
          o.setName("activity_url").setDescription(".").setRequired(false)
        )
        .addStringOption((o) =>
          o
  ...
  async execute(client, data, interaction) {
    ...
    if (action === "new") {
      ...
      const redisPrefix =
        interaction.options.getString("redis_prefix", false) || "";
      const prefix = interaction.options.getString("prefix", false) || ">";
      const status = interaction.options.getString("status", false) || "online";
      const activityText =
        interaction.options.getString("activity_text", false) || "";
      const activityType =
        interaction.options.getString("activity_type", false) || "";
      const activityUrl =
        interaction.options.getString("activity_url", false) || "";
      ...
      const pServer = await pClient.createServer(
        new ServerBuilder()
          ...
          .addEnvironmentVariable(
            "THREADED_API_URL",
            process.env["THREADED_API_URL"]
          )
          .addEnvironmentVariable(
            "THREADED_API_TOKEN",
            process.env["THREADED_API_TOKEN"]
          )
