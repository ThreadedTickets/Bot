...
const applicationTriggerSchema = new mongoose.Schema({
...
export const ApplicationSchemaValidator = ajv.compile(avjApplicationSchema);
...
const ticketTriggerSchema = new mongoose.Schema({
  _id: { type: String, required: true },
  server: {
    type: String,
    ref: "Guilds",
